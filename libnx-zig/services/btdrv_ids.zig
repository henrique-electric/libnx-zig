...
// AdType
pub const BtdrvAdType = enum(i32) {
...
pub const BtdrvAppearanceCategoryType = enum(i32) {
...
// AppearanceType
pub const BtdrvAppearanceType = enum(i32) {
...
pub const BtdrvGattServiceUuidType = enum(i32) {
...
pub const BtdrvGattCharacteristicUuidType = enum(i32) {
...
pub const BtdrvGattDescriptorUuidType = enum(i32) {
